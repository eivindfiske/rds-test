...
namespace rds_test.Pages.Admin
{
        ...
        public class RestoreUserModel : PageModel
        {
            ...
            public RestoreUserModel(ApplicationContext context, UserManager<ApplicationUser> userManager)
            {
                _context = context;
            ...
            if (id == null || _context.applicationUsers == null)
                ...
                else
                {
                    ...
                    applicationUsers.LockoutEnd = DateTime.UtcNow.AddSeconds(1);
                    applicationUsers.Lockout = false;
